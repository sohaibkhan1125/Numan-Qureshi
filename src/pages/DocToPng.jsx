...
const DocToPng = () => {
    ...
    const API_URL = 'https://v2.convertapi.com/convert/docx/to/png?Secret=' + API_KEY;
        ...
        <div className="min-h-screen bg-[#fbfcfe] pt-32 pb-16 px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <header className="mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
                    <h1 className="text-4xl sm:text-5xl font-black text-[#1E2A5E] mb-4 tracking-tight">DOC to PNG</h1>
                    <p className="text-gray-500 text-lg font-medium opacity-80 max-w-2xl mx-auto">
                        High-fidelity lossless synthesis. Convert Word documents into optimized PNG gallery assets in seconds.
                    </p>
                </header>
                        ...
                        <div className="p-10 sm:p-14 bg-gray-50/30">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest leading-none mt-1 opacity-60">Lossless · Batch Uploads</p>
                                </div>
                            ...
                            <div className="mt-12 space-y-6 pt-10 text-left border-t border-gray-100">
                                <div className="flex items-start gap-4">
                                    ...
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">Lossless Compression Synthesis</p>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center flex-shrink-0 shadow-sm"><svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg></div>
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">High-Fidelity Document Buffering</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white">
                            ...
                            {selectedFiles.length === 0 ? (
                                <div className="text-center py-20 opacity-20">
                                    <p className="text-[#1E2A5E] font-black uppercase text-[10px] tracking-[5px]">Waiting for Documents</p>
                                </div>
                            ) : (
                            ...
                            <div className="mt-10 pt-8 border-t border-gray-50">
                                ...
                                >
                                    {isConverting ? 'Synthesizing...' : 'Convert to PNG'}
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col items-center gap-6">
                                ...
                                <div>
                                    <p className="text-[#1E2A5E] font-black text-sm uppercase tracking-[5px]">
                                        {currentFile ? `Synthesizing: ${currentFile}` : 'RE-VECTORIZING PAGES...'}
                                    </p>
                                    <p className="text-gray-400 text-[10px] mt-2 uppercase font-black tracking-widest leading-none opacity-50">Mapping Document Nodes to Crisp PNG Buffers</p>
                                </div>
                            </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white border-t border-gray-100 text-left animate-in fade-in duration-700">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[10px] font-black mt-2 uppercase tracking-widest opacity-60">High-Resolution PNG Pages Generated</p>
                                </div>

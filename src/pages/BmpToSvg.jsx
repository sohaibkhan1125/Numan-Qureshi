...
const BmpToSvg = () => {
    ...
    const API_URL = 'https://v2.convertapi.com/convert/bmp/to/svg?Secret=' + API_KEY;
    ...
    const b64ToBlob = (b64, mime = 'image/svg+xml') => {
        ...
        <div className="min-h-screen bg-[#fbfcfe]">
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 text-center">
                <header className="mb-12">
                    <h1 className="text-4xl sm:text-5xl font-black mb-4 tracking-tight text-[#1E2A5E]">BMP to SVG</h1>
                    <p className="text-[#1E2A5E]/60 text-lg font-bold max-w-2xl mx-auto uppercase tracking-wider">
                        High-fidelity vector synthesis. Convert bitmap images into scalable, resolution-independent SVG assets in seconds.
                    </p>
                </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                        ...
                        <div className="p-10 sm:p-14 bg-gray-50/30">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest leading-none mt-1">Cloud Ready · Multi-Vector</p>
                                </div>
                            ...
                            <div className="mt-12 space-y-6 pt-10 text-left border-t border-gray-100">
                                <div className="flex items-start gap-4">
                                    ...
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">Resolution-Independent Synthesis</p>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center flex-shrink-0 shadow-sm"><svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg></div>
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">Vector Path Preservation Logic</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white">
                            ...
                            <div className="mt-10 pt-8 border-t border-gray-50 uppercase tracking-widest text-[#1E2A5E]">
                                ...
                                >
                                    {isConverting ? 'RE-VECTORIZING...' : 'CONVERT TO SVG'}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    {isConverting && (
                        <div className="p-12 bg-gray-50 border-t border-gray-100 text-center animate-in fade-in duration-500">
                            <div className="flex flex-col items-center gap-6">
                                ...
                                <div>
                                    <p className="text-[#1E2A5E] font-black text-sm uppercase tracking-[5px]">RE-VECTORIZING LAYERS...</p>
                                    <p className="text-gray-400 text-[10px] mt-2 uppercase font-bold tracking-widest leading-none">Mapping Bitmap Pixels to Scalable SVG Paths</p>
                                </div>
                            </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white border-t border-gray-100 text-left">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[10px] font-bold mt-2 uppercase tracking-widest opacity-60">High-Resolution SVG Vectors Generated</p>
                                </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 pb-4">
                                {generatedFiles.map((f, i) => (
                                    <div key={i} className="asset-card bg-gray-50/50 border border-gray-100 rounded-2xl overflow-hidden group animate-in zoom-in-95 duration-500 shadow-sm hover:shadow-xl">
                                        <div className="aspect-square bg-white relative p-4 flex items-center justify-center overflow-hidden">
                                            ...
                                            <div className="absolute inset-0 bg-[#1E2A5E]/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                                 <button onClick={() => downloadFile(f.url, f.name)} className="p-4 bg-white text-[#4F6EF7] rounded-full shadow-lg hover:scale-110 transition-transform">

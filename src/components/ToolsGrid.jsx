...
const tools = [
  ...
  { name: 'Content Improver', path: '/content-improver', category: 'AI Write', icon: (
  ...
  { name: 'Essay Writer', path: '/essay-writer', category: 'AI Write', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
  ), desc: 'Easily create an essay with AI', color: 'text-[#ff9248]', bgColor: 'bg-[#eab308]/15', iconColor: 'text-[#eab308]' },
  
  { name: 'Paragraph Writer', path: '/paragraph-writer', category: 'AI Write', icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
  ), desc: 'Generate a perfect paragraph on any topic instantly', color: 'text-[#ff9248]', bgColor: 'bg-[#eab308]/15', iconColor: 'text-[#eab308]' },
  ...
  { name: 'Remove Background', category: 'Image Tools', path: '/remove-background', icon: (

...
const AiToPng = () => {
    ...
    const API_URL = 'https://v2.convertapi.com/convert/ai/to/png?Secret=' + API_KEY;
        ...
        <div className="min-h-screen bg-[#fbfcfe]">
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 text-center">
                <header className="mb-12">
                    <h1 className="text-4xl sm:text-5xl font-black mb-4 tracking-tight text-[#1E2A5E]">AI to PNG</h1>
                    <p className="text-[#1E2A5E]/60 text-lg font-bold max-w-2xl mx-auto uppercase tracking-wider">
                        Professional vector synthesis. Convert Adobe Illustrator files into high-density PNG assets with alpha transparency.
                    </p>
                </header>
                        ...
                        <div className="p-10 sm:p-14 bg-gray-50/30">
                            ...
                            <div className="mt-12 space-y-6 pt-10 text-left border-t border-gray-100">
                                <div className="flex items-start gap-4">
                                    ...
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">Alpha Channel Retainment</p>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center flex-shrink-0 shadow-sm"><svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg></div>
                        ...
                        <div className="p-12 bg-gray-50 border-t border-gray-100 text-center animate-in fade-in duration-500">
                            <div className="flex flex-col items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[10px] mt-2 uppercase font-bold tracking-widest leading-none">Mapping Illustration Paths to Transparent PNG Buffers</p>
                                </div>
                            </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white border-t border-gray-100 text-left">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[10px] font-bold mt-2 uppercase tracking-widest opacity-60">High-Resolution Transparent Assets Generated</p>
                                </div>
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        { icon: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" /></svg>, title: "Secure Vector Stream", text: "TLS 1.3 encryption ensures your vector files are isolated and pruned immediately post-synthesis." }
                    ].map((feature, i) => (

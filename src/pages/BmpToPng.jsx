...
const BmpToPng = () => {
    ...
    const API_URL = 'https://v2.convertapi.com/convert/bmp/to/png?Secret=' + API_KEY;
    ...
    return (
        <div className="min-h-screen bg-[#fbfcfe]">
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .png-badge { background: linear-gradient(135deg, #0EA5E9, #2563EB); }
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 text-center">
                <header className="mb-12">
                    <h1 className="text-4xl sm:text-5xl font-black mb-4 tracking-tight text-[#1E2A5E]">BMP to PNG</h1>
                    <p className="text-[#1E2A5E]/60 text-lg font-bold max-w-2xl mx-auto uppercase tracking-wider">
                        High-fidelity lossless synthesis. Convert massive bitmap files into optimized PNG gallery assets in seconds.
                    </p>
                </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                        ...
                        <div className="p-10 sm:p-14 bg-gray-50/30">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest leading-none mt-1">Lossless · Batch Uploads</p>
                                </div>
                            ...
                            <div className="mt-12 space-y-6 pt-10 text-left border-t border-gray-100">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center flex-shrink-0 shadow-sm"><svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg></div>
                                    <p className="text-gray-400 text-[11px] font-black uppercase tracking-[2px] leading-relaxed">Alpha-Layer Transparency Preservation</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white">
                            ...
                            <div className="mt-10 pt-8 border-t border-gray-50 uppercase tracking-widest text-[#1E2A5E]">
                                ...
                                >
                                    {isConverting ? 'ENCODING...' : 'CONVERT TO PNG'}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    {isConverting && (
                        <div className="p-12 bg-gray-50 border-t border-gray-100 text-center animate-in fade-in duration-500">
                            <div className="flex flex-col items-center gap-6">
                                ...
                                <div>
                                    <p className="text-[#1E2A5E] font-black text-sm uppercase tracking-[5px]">ENCODING LOSSLESS STREAM...</p>
                                    <p className="text-gray-400 text-[10px] mt-2 uppercase font-bold tracking-widest leading-none">Mapping Bitmap Objects to Efficient PNG Nodes</p>
                                </div>
                            </div>
                        ...
                        <div className="p-10 sm:p-14 bg-white border-t border-gray-100 text-left">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[10px] font-bold mt-2 uppercase tracking-widest opacity-60">High-Resolution PNG Assets Generated</p>
                                </div>

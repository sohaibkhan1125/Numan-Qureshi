...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-2 px-4 shadow-inner">
        <div className="container mx-auto flex items-center justify-center gap-4 text-center">
          <p className="text-[11px] sm:text-xs font-bold uppercase tracking-[0.1em] opacity-90 hidden sm:block">
            Support center
          </p>
          <div className="h-4 w-px bg-white/20 hidden sm:block"></div>
          <p className="text-xs sm:text-sm font-black tracking-tight leading-none">
            If you face any issue using any tools then you can contact with us.
          </p>
          <Link 
            to="/contact" 
            className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest transition-all shadow-lg active:scale-95 whitespace-nowrap"
          >
            Contact Us
          </Link>
        </div>

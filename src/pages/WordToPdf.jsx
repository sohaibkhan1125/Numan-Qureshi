...
const WordToPdf = () => {
    ...
    const handleConvert = async () => {
        ...
        try {
            const data = await convertWordToPdf(file);
        ...
        <div className="min-h-screen bg-slate-50 pt-28 pb-20 px-4">
            <div className="container mx-auto max-w-4xl">
                <div className="text-center mb-12">
                    ...
                    >
                        Easily transform Word documents into high-quality PDF files. Fast, accurate, and completely secure.
                    </motion.p>
                </div>
                    ...
                    <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    {file ? (
                                        ...
                                        <div className="text-center">
                                            <h3 className="text-2xl font-black text-slate-800 mb-3">Upload Word Document</h3>
                                            <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Drag and drop or click to upload .docx / .doc</p>
                                        </div>
                                    )}
                                </div>
                        ...
                        {status === 'processing' && (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black text-slate-800 mb-2">Generating PDF</h3>
                                <p className="text-slate-400 font-bold uppercase tracking-widest text-xs flex items-center gap-2">
                                    <Loader2 className="w-4 h-4 animate-spin text-orange-500" />
                                    Optimizing layout and fonts...
                                </p>
                            </motion.div>
                        )}
                        ...
                        {status === 'success' && (
                            ...
                            >
                                ...
                                <h3 className="text-3xl md:text-4xl font-black text-slate-800 mb-4 text-center">Success!</h3>
                                <p className="text-slate-500 font-medium text-center mb-12 max-w-md">Your PDF document has been created and is ready for download.</p>
                                ...
                                <div className="w-full bg-slate-50 rounded-3xl p-6 mb-12 border border-slate-100 flex items-center justify-between group hover:bg-orange-50/30 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Portable Document Format</p>
                                        </div>
                                    </div>
                                    <a 
                                        href={result?.Url}
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    {[
                        { title: 'Any Word Format', desc: 'Convert both .doc and .docx formats from Word 2007 to modern versions.' },
                        { title: 'Crystal Clear', desc: 'Ensures text remains sharp and vector assets remain high resolution.' },
                        { title: 'Privacy First', desc: 'Secure processing with automatic file deletion—your data is safe with us.' }
                    ].map((feature, i) => (

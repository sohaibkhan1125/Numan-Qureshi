...
const API_URL = `https://v2.convertapi.com/convert/pdf/to/jpg?Secret=${API_KEY}`;
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const list = (data.Files || []).map((f) => {
        const blob = b64ToBlob(f.FileData, 'image/jpeg');
        return blob.then((b) => {
    ...
    <div className="min-h-screen bg-[#fbfcfe] pt-32 pb-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <header className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-black text-[#1E2A5E] mb-4 tracking-tight">PDF to JPG</h1>
          <p className="text-gray-500 text-lg font-medium opacity-80 max-w-2xl mx-auto">
            High-fidelity page synthesis. Convert each PDF page into a high-quality JPG asset in seconds.
          </p>
        </header>
            ...
            <div className="p-10 sm:p-14 bg-gray-50/30">
              ...
              <div
                className={`border-2 border-dashed rounded-[2.5rem] flex flex-col items-center justify-center p-14 cursor-pointer transition-all bg-white hover:border-[#4F6EF7] hover:bg-blue-50/20 group relative ${
                  isDropActive ? 'border-[#4F6EF7]' : 'border-gray-100'
                }`}
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest leading-none mt-1">Cloud Ready · High Res</p>
                </div>
                <input
                  ref={fileInputRef}
                  type="file"
              ...
              <div className="mt-12 space-y-6 pt-10 text-left border-t border-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-400 text-[11px] font-bold uppercase tracking-wide leading-relaxed">Full Resolution Synthesis</p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center flex-shrink-0">
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-gray-400 text-[11px] font-bold uppercase tracking-wide leading-relaxed">Cross-Platform Vector Optimization</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-10 sm:p-14 bg-white">
              ...
              {!selectedFile ? (
                ...
                <div className="space-y-4 animate-in slide-in-from-right-2 duration-300">
                  <div className="bg-gray-50/50 border border-gray-100 rounded-3xl p-5 flex items-center gap-5">
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-[10px] mt-2 uppercase font-bold tracking-widest leading-none">
                    Mapping PDF Streams to High-Quality Bitmaps
                  </p>
                </div>
              </div>
              <div className="h-1.5 bg-gray-200 rounded-full overflow-hidden mt-10 max-w-sm mx-auto">
                <div
                  className="h-full rounded-full transition-all duration-300 bg-gradient-to-r from-[#4F6EF7] via-[#7C3AED] to-[#4F6EF7] bg-[length:400px_100%]"
            ...
            <div ref={resultsRef} className="p-10 sm:p-14 bg-white border-t border-gray-100 text-left">
              <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-gray-400 text-[10px] font-bold mt-2 uppercase tracking-widest opacity-60">High-Fidelity JPG Assets Generated</p>
                </div>
                <button
                  type="button"
                  onClick={downloadAll}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 pb-4">
                {generatedImages.map((img, i) => (
                  <div
                    key={img.url}
                    className="bg-gray-50 rounded-2xl overflow-hidden shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-100 group"
                  >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {[
            { t: 'Elite Engine', d: 'Global cloud nodes ensure your complex vector PDFs are synthesized into pixel-perfect JPGs in seconds.' },

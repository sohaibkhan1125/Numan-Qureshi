...
const Footer = () => {
  return (
    <footer className="footer bg-white border-t border-slate-100 pt-16 pb-6">
      ...
      {/* Copyright Bar */}
      <div className="w-full bg-[#fafafa] border-t border-slate-50 mt-10 py-6">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-slate-500 text-sm font-medium">
            &copy; {new Date().getFullYear()} Gugly Mugly. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <Link to="/privacy-policy" className="text-slate-500 hover:text-[#3b82f6] transition-colors text-sm font-medium">
              Privacy Policy
            </Link>
            <Link to="/terms-and-conditions" className="text-slate-500 hover:text-[#3b82f6] transition-colors text-sm font-medium">
              Terms & Conditions
            </Link>
          </div>
        </div>

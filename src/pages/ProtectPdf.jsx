...
import { Lock, ShieldCheck, Download, Upload, CheckCircle, AlertCircle, Loader2, KeyRound } from 'lucide-react';
...
const ProtectPdf = () => {
    ...
    const handleProtect = async () => {
        ...
        try {
            const data = await protectPdf(file, password);
        ...
        <div className="min-h-screen bg-slate-50 pt-28 pb-20 px-4">
            <div className="container mx-auto max-w-4xl">
                <div className="text-center mb-12">
                    ...
                    >
                        Protect <span className="text-emerald-500">PDF</span>
                    </motion.h1>
                    <motion.p 
                        initial={{ opacity: 0, y: -10 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Encrypt your PDF documents with a strong password to prevent unauthorized access, copying, or modifying.
                    </motion.p>
                </div>
                    ...
                    <AnimatePresence mode="wait">
                        {status === 'idle' && (
                            ...
                            >
                                {!file ? (
                                    ...
                                    >
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Upload your file to secure it</p>
                                        </div>
                                    </div>
                                ) : (
                                ...
                                <button
                                    ...
                                    disabled={!file || !password || password.length < 3}
                                    className={`mt-8 px-12 py-5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] transition-all duration-300 shadow-xl active:scale-95 ${
                                        file && password && password.length >= 3 
                        ...
                        {status === 'processing' && (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black text-slate-800 mb-2">Encrypting Document</h3>
                                <p className="text-slate-400 font-bold uppercase tracking-widest text-xs flex items-center gap-2">
                                    <Loader2 className="w-4 h-4 animate-spin text-emerald-500" />
                                    Applying 256-bit AES protection...
                                </p>
                            </motion.div>
                        )}
                        ...
                        {status === 'success' && (
                            ...
                            >
                                ...
                                <h3 className="text-3xl md:text-4xl font-black text-slate-800 mb-4 text-center">Successfully Protected!</h3>
                                <p className="text-slate-500 font-medium text-center mb-12 max-w-md">Your PDF document has been safely encrypted with the provided password.</p>
                                ...
                                <div className="w-full bg-emerald-50/50 rounded-3xl p-6 mb-12 border border-emerald-100 flex items-center justify-between group hover:bg-emerald-50 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Protected PDF Document</p>
                                        </div>
                                    </div>
                                    <a 
                                        href={result?.Url}
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    {[
                        { title: 'Bank-Level Security', desc: 'We utilize top-tier encryption standards (AES) directly native to PDF specification guidelines.' },
